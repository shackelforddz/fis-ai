...
export const loanEvaluations: LoanEvaluation[] = [
  {
    id: "loan-001",
    borrowerName: "Blue Harbor Development Group",
...
// ───────────────────────────────────────────────────────────────
// Mock data backing the copilot's recommended prompts
// ───────────────────────────────────────────────────────────────

// Defensive insights — UCC filings filed by competing lenders
export const competitorUccFilings = [
  {
    id: "ucc-comp-001",
    filingDate: "2026-04-12",
    debtorName: "Vanguard Logistics Ltd.",
    debtorIsOurCustomer: true,
    ourBorrowerId: "bor-001",
    competitorLender: "Apex Capital Partners",
    jurisdiction: "Ohio Secretary of State",
    collateral: "Fleet equipment & rolling stock",
    estimatedAmount: 1_800_000,
  },
  {
    id: "ucc-comp-002",
    filingDate: "2026-04-08",
    debtorName: "Coastal Health Services",
    debtorIsOurCustomer: true,
    ourBorrowerId: "bor-003",
    competitorLender: "Atlantic Mutual Bank",
    jurisdiction: "Virginia State Corporation Commission",
    collateral: "Medical equipment leaseline",
    estimatedAmount: 950_000,
  },
  {
    id: "ucc-comp-003",
    filingDate: "2026-03-30",
    debtorName: "Brightline Manufacturing Co.",
    debtorIsOurCustomer: false,
    competitorLender: "Cornerstone Commercial",
    jurisdiction: "Indiana Secretary of State",
    collateral: "All assets blanket lien",
    estimatedAmount: 4_250_000,
  },
  {
    id: "ucc-comp-004",
    filingDate: "2026-03-22",
    debtorName: "TechVenture Solutions Inc",
    debtorIsOurCustomer: true,
    ourBorrowerId: "bor-005",
    competitorLender: "Silicon Trust Bank",
    jurisdiction: "California Secretary of State",
    collateral: "Receivables and inventory",
    estimatedAmount: 2_100_000,
  },
  {
    id: "ucc-comp-005",
    filingDate: "2026-03-15",
    debtorName: "Northline Manufacturing",
    debtorIsOurCustomer: false,
    competitorLender: "First Heritage Bank",
    jurisdiction: "Michigan Department of State",
    collateral: "Production line equipment",
    estimatedAmount: 1_400_000,
  },
];

// Networking — recent interactions per borrower (last 3-5 each)
export const borrowerInteractions = [
  // bor-001 Vanguard Logistics
  {
    id: "int-001",
    borrowerId: "bor-001",
    borrowerName: "Vanguard Logistics Ltd.",
    ...
    summary:
      "Reviewed Q1 financials with CFO. Tone constructive but flagged fuel-cost pressure on margins. Asked about hedging products.",
    sentiment: "Positive",
  },
  {
    id: "int-002",
    ...
    type: "Email",
    summary:
      "CEO declined our offered rate on the seasonal expansion line — said competitor came in 25 bps tighter. We held terms.",
    sentiment: "Negative",
  },
  {
    id: "int-003",
    ...
    type: "On-site visit",
    summary:
      "Toured the Columbus distribution facility with operations VP. Saw the new cross-dock build. Discussed potential CapEx loan for fleet upgrades.",
    sentiment: "Positive",
  },
  // bor-005 TechVenture Solutions
  {
    id: "int-004",
    borrowerId: "bor-005",
    borrowerName: "TechVenture Solutions Inc",
    ...
    type: "Phone call",
    summary:
      "CFO requested expedited turn on the Floor 14-16 buildout permit-tied advance. Indicated competitive pricing pressure from Silicon Trust.",
    sentiment: "Neutral",
  },
  {
    id: "int-005",
    ...
    type: "Quarterly review",
    summary:
      "Strong Q4. Discussed capital plan; founder open to expanding banking relationship if execution is strong on the buildout draw.",
    sentiment: "Positive",
  },
  {
    id: "int-006",
    ...
    type: "Email",
    summary:
      "Forwarded an article on AI infrastructure costs — borrower replied with thanks and noted the datacenter pod project was driven by similar dynamics.",
    sentiment: "Positive",
  },
  // bor-003 Coastal Health Services
  {
    id: "int-007",
    borrowerId: "bor-003",
    borrowerName: "Coastal Health Services",
    ...
    type: "Phone call",
    summary:
      "CEO asked about competitor's medical equipment leaseline. Reiterated value of our existing line; offered a side-by-side comparison.",
    sentiment: "Neutral",
  },
  {
    id: "int-008",
    ...
    type: "Quarterly review",
    summary:
      "Reviewed expansion permit progress in Norfolk. Borrower confident in timeline. No covenant concerns raised.",
    sentiment: "Positive",
  },
  {
    id: "int-009",
    ...
    type: "On-site visit",
    summary:
      "Site walk of existing outpatient center. Met with CMO; she emphasized regulatory headwinds in ambulatory reimbursement.",
    sentiment: "Neutral",
  },
];

// Networking — recent news per borrower
export const borrowerNews = [
  {
    id: "news-001",
    borrowerId: "bor-001",
    borrowerName: "Vanguard Logistics Ltd.",
    ...
    headline:
      "Vanguard Logistics breaks ground on 180,000 sq ft Columbus cross-dock facility",
    summary:
      "Coverage of the new facility build. Quotes from CEO highlighting capacity expansion and Midwest distribution strategy.",
  },
  {
    id: "news-002",
    borrowerId: "bor-001",
    borrowerName: "Vanguard Logistics Ltd.",
    date: "2026-04-09",
    source: "Trucking Industry Today",
    headline: "Diesel costs spike 8% in Q1 — regional carriers absorbing margin",
    summary:
      "General industry article naming Vanguard among carriers reportedly delaying surcharge updates due to long-term shipper contracts.",
  },
  {
    id: "news-003",
    borrowerId: "bor-001",
    ...
    headline: "Vanguard names new Chief Operating Officer",
    summary:
      "Promotion of internal VP to COO. Vanguard signaled focus on operational efficiency through 2026.",
  },
  {
    id: "news-004",
    borrowerId: "bor-005",
    ...
    date: "2026-04-18",
    source: "TechCrunch",
    headline: "TechVenture closes Series D-2 extension at $1.2B valuation",
    summary:
      "$80M extension led by existing investor. Funds earmarked for SF datacenter buildout and engineering hiring.",
  },
  {
    id: "news-005",
    borrowerId: "bor-005",
    ...
    headline: "Bay Area office leasing rebounds — TechVenture signs floors 14-16",
    summary:
      "Article on SF office market recovery. TechVenture's three-floor lease cited as a marquee deal.",
  },
  {
    id: "news-006",
    borrowerId: "bor-003",
    ...
    headline: "Norfolk regulators advance Coastal's ambulatory wing permit",
    summary:
      "Local zoning board approved Phase 1 of the 22,000 sq ft expansion. Construction expected to commence Q3 2026.",
  },
];

// Market gaps — high-growth prospects without a product with us
export const growthProspects = [
  {
    id: "prospect-001",
    name: "Ridgeline Brewing Co.",
    industry: "Food & Beverage",
    yoyGrowthPct: 22,
    estimatedRevenue: 18_400_000,
    headquarters: "Asheville, NC",
    existingLender: "Carolina Heritage Bank",
    relationshipNote:
      "Founder met with our regional president at an industry conference in March 2026. No active products.",
  },
  {
    id: "prospect-002",
    ...
    existingLender: "First Allegheny Bank",
    relationshipNote: "No prior relationship. Recently filed UCC for new robotics line.",
  },
  {
    id: "prospect-003",
    name: "Cascade Cold Logistics",
    industry: "Transportation & Warehousing",
    yoyGrowthPct: 17,
    estimatedRevenue: 26_500_000,
    headquarters: "Portland, OR",
    existingLender: "Pacific Northwest Trust",
    relationshipNote:
      "Operates cold-chain warehouses. Expansion permits suggest CapEx need within 12 months.",
  },
  {
    id: "prospect-004",
    name: "Beacon Specialty Pharmacy",
    industry: "Healthcare",
    yoyGrowthPct: 28,
    estimatedRevenue: 14_900_000,
    headquarters: "Charlotte, NC",
    existingLender: "None disclosed",
    relationshipNote:
      "Bootstrapped to date. Founder has expressed interest in working capital line.",
  },
  {
    id: "prospect-005",
    name: "Helios Solar Installers",
    industry: "Renewable Energy Services",
    yoyGrowthPct: 19,
    estimatedRevenue: 9_800_000,
    headquarters: "Phoenix, AZ",
    existingLender: "Desert Mountain Bank",
    relationshipNote: "Growing residential portfolio. Equipment finance fit.",
  },
  {
    id: "prospect-006",
    name: "Anchor Marine Services",
    industry: "Maritime",
    yoyGrowthPct: 16,
    estimatedRevenue: 11_200_000,
    headquarters: "Tampa, FL",
    existingLender: "Gulf Coast Commercial",
    relationshipNote: "Acquired a competitor in 2025; capital structure may be restructure-ready.",
  },
];

// Risk — Deal intention vs reality: borrowers paying debt service from Interest Reserve
export const interestReserveStatus = [
  {
    borrowerId: "bor-001",
    borrowerName: "Harbor Crew Holdings",
    facilityId: "TX-9928-BA",
    monthsPaidFromReserve: 4,
    reserveDrawn: 425_000,
    reserveRemaining: 95_000,
    monthlyDebtService: 121_000,
    flag: "Reserve exhausted within ~1 month at current pace",
  },
  {
    borrowerId: "bor-004",
    borrowerName: "Summit Steel Distributors",
    facilityId: "OH-4421-CL",
    monthsPaidFromReserve: 2,
    reserveDrawn: 180_000,
    reserveRemaining: 320_000,
    monthlyDebtService: 92_000,
    flag: "Recent slip — first quarter paying from reserve",
  },
  {
    borrowerId: "bor-006",
    borrowerName: "Prairie Agricultural Co-op",
    facilityId: "IA-7712-AG",
    monthsPaidFromReserve: 3,
    reserveDrawn: 240_000,
    reserveRemaining: 160_000,
    monthlyDebtService: 78_000,
    flag: "Seasonal — historical pattern but trending longer this cycle",
  },
];

// Risk — Behavioral: payment date extension requests in the last 6 months
export const paymentExtensionRequests = [
  {
    id: "ext-001",
    borrowerId: "bor-001",
    borrowerName: "Harbor Crew Holdings",
    ...
    extendedDueDate: "2026-04-15",
    reason: "Customer payment timing",
  },
  {
    id: "ext-002",
    borrowerId: "bor-001",
    ...
    extendedDueDate: "2026-03-12",
    reason: "Fuel surcharge collection delay",
  },
  {
    id: "ext-003",
    borrowerId: "bor-001",
    ...
    extendedDueDate: "2026-02-10",
    reason: "Bank holiday timing",
  },
  {
    id: "ext-004",
    borrowerId: "bor-004",
    ...
    extendedDueDate: "2026-04-20",
    reason: "Slow A/R collections from a top-three customer",
  },
  {
    id: "ext-005",
    borrowerId: "bor-004",
  ...
  },
  {
    ...
    extendedDueDate: "2025-12-22",
    reason: "Year-end inventory build cash strain",
  },
  {
    id: "ext-007",
    borrowerId: "bor-002",
    ...
    extendedDueDate: "2026-03-25",
    reason: "One-time customer payment delay",
  },
];

// Risk — Operational & Compliance: UCC-1 filings + continuation status
export const uccContinuationTracking = [
  {
    id: "uccc-001",
    borrowerId: "bor-001",
    borrowerName: "Vanguard Logistics Ltd.",
    filingNumber: "OH-20210401-12345",
    jurisdiction: "Ohio Secretary of State",
    originalFilingDate: "2021-04-01",
    expiryDate: "2026-06-15",
    daysToExpiry: 49,
    continuationDrafted: false,
    collateral: "Fleet equipment, rolling stock",
  },
  {
    id: "uccc-002",
    borrowerId: "bor-002",
    borrowerName: "Greenfield Logistics LLC",
    filingNumber: "MN-20210522-22987",
    jurisdiction: "Minnesota Secretary of State",
    originalFilingDate: "2021-05-22",
    expiryDate: "2026-07-08",
    daysToExpiry: 72,
    continuationDrafted: true,
    collateral: "All assets blanket lien",
  },
  {
    id: "uccc-003",
    borrowerId: "bor-003",
    borrowerName: "Coastal Health Services",
    filingNumber: "VA-20210610-33112",
    jurisdiction: "Virginia State Corporation Commission",
    originalFilingDate: "2021-06-10",
    expiryDate: "2026-08-04",
    daysToExpiry: 99,
    continuationDrafted: false,
    collateral: "Medical equipment, accounts receivable",
  },
  {
    id: "uccc-004",
    borrowerId: "bor-004",
    borrowerName: "Summit Steel Distributors",
    filingNumber: "OH-20210715-44551",
    jurisdiction: "Ohio Secretary of State",
    originalFilingDate: "2021-07-15",
    expiryDate: "2026-08-22",
    daysToExpiry: 117,
    continuationDrafted: false,
    collateral: "Inventory, equipment, A/R",
  },
  {
    id: "uccc-005",
    borrowerId: "bor-005",
    borrowerName: "TechVenture Solutions Inc",
    filingNumber: "CA-20220114-99821",
    jurisdiction: "California Secretary of State",
    originalFilingDate: "2022-01-14",
    expiryDate: "2027-01-14",
    daysToExpiry: 627,
    continuationDrafted: false,
    collateral: "Receivables, intellectual property",
  },
  {
    id: "uccc-006",
    borrowerId: "bor-006",
    borrowerName: "Prairie Agricultural Co-op",
    filingNumber: "IA-20210301-55678",
    jurisdiction: "Iowa Secretary of State",
    originalFilingDate: "2021-03-01",
    expiryDate: "2026-05-30",
    daysToExpiry: 33,
    continuationDrafted: true,
    collateral: "Crops, equipment, storage facilities",
  },
];

// Loan Eval — historical approved deals for comp analysis
export const historicalApprovedDeals = [
  {
    id: "hist-001",
    dealName: "Lakeside Multifamily Refi",
    closedDate: "2025-11-08",
    propertyType: "Multifamily (120-unit)",
    loanType: "CRE Refinance",
    loanAmount: 13_500_000,
    rateBps: 285,
    rateBase: "SOFR",
    structure: "60-month term, 25-yr amortization, IO first 24 mo",
    dscrCovenant: 1.25,
    ltv: 0.68,
    debtYieldCovenant: 0.085,
    minLiquidity: 1_000_000,
    notes: "Sub-5% submarket vacancy; experienced sponsor.",
  },
  {
    id: "hist-002",
    dealName: "Brookhaven Mixed-Use Acq",
    closedDate: "2025-09-22",
    propertyType: "Mixed-use (retail + 18 apartments)",
    loanType: "CRE Acquisition",
    loanAmount: 7_200_000,
    rateBps: 315,
    rateBase: "SOFR",
    structure: "36-month term + two 12-month extensions, IO during stabilization",
    dscrCovenant: 1.3,
    ltv: 0.7,
    debtYieldCovenant: 0.082,
    minLiquidity: 750_000,
    notes: "Anchor commercial tenant with 7-yr remaining lease.",
  },
  {
    id: "hist-003",
    dealName: "Riverbend Industrial Construction",
    closedDate: "2025-07-14",
    propertyType: "Industrial (180,000 sq ft warehouse)",
    loanType: "Construction",
    loanAmount: 21_400_000,
    rateBps: 350,
    rateBase: "SOFR",
    structure: "30-month construction + 24-month mini-perm",
    dscrCovenant: 1.2,
    ltv: 0.65,
    debtYieldCovenant: 0.09,
    minLiquidity: 2_000_000,
    notes: "70% pre-leased to investment-grade tenant.",
  },
  {
    id: "hist-004",
    dealName: "Highline Apartments Value-Add",
    closedDate: "2025-05-19",
    propertyType: "Multifamily (96-unit)",
    loanType: "CRE Acquisition + Value-Add",
    loanAmount: 14_800_000,
    rateBps: 360,
    rateBase: "SOFR",
    structure: "36-month term + 12-month ext, IO 24 mo, rate cap req'd",
    dscrCovenant: 1.25,
    ltv: 0.72,
    debtYieldCovenant: 0.08,
    minLiquidity: 1_500_000,
    notes: "Comparable to current Blue Harbor request — strong direct comp.",
  },
  {
    id: "hist-005",
    dealName: "Crosswinds Retail Refi",
    closedDate: "2025-03-12",
    propertyType: "Retail (anchored center, 145k sq ft)",
    loanType: "CRE Refinance",
    loanAmount: 18_900_000,
    rateBps: 270,
    rateBase: "SOFR",
    structure: "84-month term, 25-yr amortization",
    dscrCovenant: 1.3,
    ltv: 0.6,
    debtYieldCovenant: 0.095,
    minLiquidity: 1_250_000,
    notes: "Grocer-anchored, ~95% leased.",
  },
  {
    id: "hist-006",
    dealName: "Stoneridge Mixed-Use Acq",
    closedDate: "2024-12-04",
    propertyType: "Mixed-use (retail + 22 apartments)",
    loanType: "CRE Acquisition",
    loanAmount: 8_500_000,
    rateBps: 305,
    rateBase: "SOFR",
    structure: "60-month term, 25-yr amortization",
    dscrCovenant: 1.25,
    ltv: 0.68,
    debtYieldCovenant: 0.085,
    minLiquidity: 700_000,
    notes:
      "Sponsor agreed to step-up DSCR covenant (1.20x year 1 → 1.25x stabilized).",
  },
];

// Existing portfolio — what each borrower has with us
export const borrowerProductHoldings = [
  {
    borrowerId: "bor-001",
    borrowerName: "Vanguard Logistics Ltd.",
    products: ["Revolving Credit Facility", "Treasury Management"],
  },
  {
    borrowerId: "bor-002",
    borrowerName: "Greenfield Logistics LLC",
    products: ["Term Loan", "Equipment Finance", "Operating Account"],
  },
  {
    borrowerId: "bor-003",
    borrowerName: "Coastal Health Services",
    products: ["Equipment Leaseline", "Treasury Management"],
  },
  {
    borrowerId: "bor-004",
    borrowerName: "Summit Steel Distributors",
    products: ["Asset-Based Lending", "Operating Account"],
  },
  {
    borrowerId: "bor-005",
    borrowerName: "TechVenture Solutions Inc",
    products: ["Venture Term Loan", "Operating Account"],
  },
  {
    borrowerId: "bor-006",
    borrowerName: "Prairie Agricultural Co-op",
